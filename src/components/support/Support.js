    ...
    const communityReports = [
        {
            ...
            status: "Resolved",
            response:
                "This has been fixed in the latest SteamOS update. Please update your system.",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            response:
                "Our team is investigating this issue. As a temporary fix, try setting the sample rate to 48000Hz.",
        },
    ];
                ...
                <div className={styles["contact-section"]}>
                    ...
                    <form onSubmit={handleSubmit} className={styles["contact-form"]}>
                        ...
                        <div className={styles["social-links"]}>
                            ...
                            <a
                                href="https://github.com/ValveSoftware/SteamOS"
                                target="_blank"
                                rel="noopener noreferrer"
                                className={styles["social-button"]}
